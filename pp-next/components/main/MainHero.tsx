...
const MainHero = () => {
  return (
    <div className="flex flex-col min-h-screen from-white/10 to-white/10 bg-[url('/images/main/background.webp')] bg-no-repeat bg-cover bg-center relative">
      <div
      ...
      >
        ...
        >
          프론트엔드 개발자 <strong className="font-black">이예은</strong>
          입니다.
        </h2>
